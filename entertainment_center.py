...
drive = media.Movie(
    ...
    "http://i.ebayimg.com/00/s/NTAwWDMzOA==/z/rh8AAOxycD9TVjek/$_35.JPG?set_id=2",  # noqa
...
seven = media.Movie(
    ...
    "https://images-na.ssl-images-amazon.com/images/M/MV5BOTUwODM5MTctZjczMi00OTk4LTg3NWUtNmVhMTAzNTNjYjcyXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_UY1200_CR69,0,630,1200_AL_.jpg",  # noqa
    "https://www.youtube.com/watch?v=znmZoVkCjpI")

# Each movie is grouped into a single array, which is sorted by the year
# that it was released.
movies = [pulp_fiction, primer, twothousandandone,
          drive, edge_of_tomorrow, seven]
# change to false for older first
